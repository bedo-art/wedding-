        ...
        async function handleRSVP(e) {
            ...
            try {
                const response = await fetch('https://api.web3forms.com/submit', {
                    ...
                    body: JSON.stringify({
                        access_key: 'YOUR_ACCESS_KEY_HERE', // Paste your Web3Forms key inside these quotes
                        name: name,
                        whatsapp: whatsapp,
                        attendance: attendance,
                        guests: guests,
                        subject: 'تأكيد حضور زفاف جديد!' // The subject of the email you will receive
                    })
                });

                if (response.status === 200) {
                    // If successful, clear the form and show the thank you message
